...
// INTERFACES & TYPES
// ==========================================
export type UserRole = 'admin' | 'pastor' | 'treasurer' | 'church_leader' | 'member';
...
export interface DailyStudyReading {
  day: 'Sabbath' | 'Sunday' | 'Monday' | 'Tuesday' | 'Wednesday' | 'Thursday' | 'Friday';
  title: string;
  passage: string;
  content: string;
...
export interface WeeklyStudy {
  ...
  themePassage: string;
  overview: string;
  dailyReadings: DailyStudyReading[];
  createdAt: string;
  authorName: string;
}
...
// ==========================================
// EMBEDDED MASTER DATA (FUNDAMENTAL BELIEFS)
// ==========================================
const DEFAULT_FUNDAMENTAL_BELIEFS: FundamentalBelief[] = [
  {
    id: 'fb-1',
    number: 1,
    ...
    scriptureRefs: ['2 Peter 1:20-21', '2 Timothy 3:16-17', 'Psalm 119:105', 'Proverbs 30:5-6', 'Isaiah 8:20', 'John 17:17'],
    keyVerse: 'Your word is a lamp to my feet and a light to my path. (Psalm 119:105)',
    studyQuestions: [
      'Why is scripture considered the foundational authority for Christian faith?',
      'How does the Holy Spirit assist us in understanding the Bible today?'
    ]
  },
  {
    id: 'fb-2',
    ...
    scriptureRefs: ['Genesis 1:26', 'Deuteronomy 6:4', 'Matthew 28:19', '2 Corinthians 13:14', '1 Peter 1:2'],
    keyVerse: 'Go therefore and make disciples of all nations, baptizing them in the name of the Father and of the Son and of the Holy Spirit. (Matthew 28:19)',
    studyQuestions: [
      'What does the unity of the Godhead teach us about divine relationships?',
      'How do the Father, Son, and Holy Spirit cooperate in our salvation?'
    ]
  },
  {
    id: 'fb-3',
    ...
    fullText: 'God the eternal Father is the Creator, Source, Sustainer, and Sovereign of all creation. He is holy and loving, merciful and gracious, slow to anger, and abounding in steadfast love and faithfulness. The qualities and powers exhibited in the Son and the Holy Spirit are also revelations of the Father.',
    scriptureRefs: ['Genesis 1:1', 'Revelation 4:11', '1 Corinthians 15:28', 'John 3:16', '1 John 4:8'],
    keyVerse: 'For God so loved the world that He gave His only begotten Son, that whoever believes in Him should not perish but have everlasting life. (John 3:16)',
    studyQuestions: [
      'How does viewing God as a loving Father change our daily prayer life?',
      'What aspects of God’s character stand out most to you?'
    ]
  },
  {
    id: 'fb-4',
    ...
    title: 'God the Son',
    category: 'God',
    summary: 'God the eternal Son became incarnate in Jesus Christ to accomplish human redemption.',
    fullText: 'God the eternal Son became incarnate in Jesus Christ. Through Him all things were created, the character of God is revealed, the salvation of humanity is accomplished, and the world is judged. Forever truly God, He became also truly human, Jesus the Christ. He was conceived of the Holy Spirit and born of the virgin Mary. He lived and experienced temptation as a human being, but perfectly exemplified the righteousness and love of God.',
    scriptureRefs: ['John 1:1-3, 14', 'Colossians 1:15-19', 'Philippians 2:5-11', 'Hebrews 2:14-18', '1 Corinthians 15:3-4'],
    keyVerse: 'And the Word became flesh and dwelt among us, and we beheld His glory. (John 1:14)',
    studyQuestions: [
      'Why was it essential for Jesus to be both fully God and fully human?',
      'What does Christ’s resurrection guarantee for believers?'
    ]
  },
  {
    id: 'fb-5',
    ...
    category: 'God',
    summary: 'God the eternal Spirit inspired the Scriptures and empowers the believers and the Church.',
    fullText: 'God the eternal Spirit was active with the Father and the Son in Creation, incarnation, and redemption. He is as much a person as are the Father and the Son. He inspired the writers of Scripture. He filled Christ’s life with power. He draws and convicts human beings; and those who respond He renews and transforms into the image of God. Sent by the Father and the Son to be always with His children, He extends spiritual gifts to the church.',
    scriptureRefs: ['Genesis 1:1-2', 'Luke 1:35', 'John 14:16-18, 26', 'Acts 1:8', 'Ephesians 4:30'],
    keyVerse: 'But you shall receive power when the Holy Spirit has come upon you; and you shall be witnesses to Me. (Acts 1:8)',
    studyQuestions: [
      'How can we yield more fully to the guidance of the Holy Spirit?',
      'What role does the Holy Spirit play in personal conviction and transformation?'
    ]
  },
  {
    id: 'fb-6',
    ...
    title: 'Creation',
    category: 'God',
    summary: 'God is the Sovereign Creator of all things, creating the universe and world in six literal days.',
    fullText: 'God has revealed in Scripture the authentic and historical account of His creative activity. He created the universe, and in a recent six-day creation the Lord made the heavens and the earth, the sea, and all that is in them, and rested on the seventh day. Thus He established the Sabbath as a perpetual memorial of His finished creative work.',
    scriptureRefs: ['Genesis 1-2', 'Exodus 20:8-11', 'Psalm 19:1-6', 'Hebrews 11:3', 'Revelation 14:7'],
    keyVerse: 'For in six days the Lord made the heavens and the earth, the sea, and all that is in them, and rested the seventh day. (Exodus 20:11)',
    studyQuestions: [
      'How does the doctrine of Creation reinforce human dignity and purpose?',
      'What is the spiritual link between Creation and the Sabbath rest?'
    ]
  },
  {
    id: 'fb-7',
    ...
    category: 'Humanity',
    summary: 'Man and woman were made in the image of God with individuality, freedom, and personal responsibility.',
    ...
    scriptureRefs: ['Genesis 1:26-28', 'Genesis 2:7', 'Psalm 8:3-8', 'Acts 17:24-28', 'Romans 5:12-17'],
    keyVerse: 'So God created man in His own image; in the image of God He created him; male and female He created them. (Genesis 1:27)',
    studyQuestions: [
      'What does it mean that human beings are an indivisible unity of body, mind, and spirit?',
      'How does the Gospel restore God’s image within us?'
    ]
  },
  {
    id: 'fb-8',
    ...
    category: 'Salvation',
    summary: 'All humanity is now involved in a great controversy between Christ and Satan regarding God’s character.',
    fullText: 'All humanity is now involved in a great controversy between Christ and Satan regarding the character of God, His law, and His sovereignty over the universe. This conflict originated in heaven when a created being, endowed with freedom of choice, in self-exaltation became Satan, God’s adversary, and led a portion of the angels into rebellion.',
    scriptureRefs: ['Isaiah 14:12-14', 'Ezekiel 28:12-18', 'Revelation 12:4-9', 'Genesis 3', 'Romans 1:19-32'],
    keyVerse: 'And war broke out in heaven: Michael and his angels fought with the dragon; and the dragon and his angels fought. (Revelation 12:7)',
    studyQuestions: [
      'How does understanding the Great Controversy answer the problem of suffering?',
      'In what ways do our daily choices align us with Christ in this conflict?'
    ]
  },
  {
    id: 'fb-9',
    ...
    category: 'Salvation',
    summary: 'In Christ’s life of perfect obedience, His suffering, death, and resurrection, God provided the only means of atonement.',
    fullText: 'In Christ’s life of perfect obedience to God’s will, His suffering```typescript
'use client';
